...
from ..core.models import Job, ModelWithCreateUpdateTimestamp, ModelWithMetadata
...
class InvoiceBrand(ModelWithCreateUpdateTimestamp,ModelWithMetadata):
    ...
    brand = models.ForeignKey(Brand, on_delete=models.CASCADE ,related_name="through_invoice_brand")
