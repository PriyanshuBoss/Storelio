...
class ModelWithCreateTimestamp(models.Model):
...
class ModelWithCreateUpdateTimestamp(models.Model):
    created_at = models.DateTimeField(auto_now_add=True, editable=False)
    updated_at = models.DateTimeField(auto_now=True)
...
class ModelWithActiveState(models.Model):
...
class BaseBankAccountModel(models.Model):
    ...
    ac_bank_name = models.CharField(
        max_length=128,
        verbose_name='Bank Name')
    ac_bank_branch = models.CharField(
        max_length=256,
        verbose_name='Bank Branch')
    ac_ifsc_code = models.CharField(
        max_length=16,
...
class ApiApp(ModelWithCreateUpdateTimestamp,ModelWithMetadata):
    ...
    token_expires_at = models.DateTimeField(auto_now_add=True)
