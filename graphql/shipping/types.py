...
class ZipcodeData(graphene.ObjectType):
    city = graphene.String(description="Name of the city")
    state = graphene.String(description="Name of the State")
    country = graphene.String(description="Name of the country")
    error = graphene.String(description="Error from the api ")
