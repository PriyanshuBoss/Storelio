...
from ...payment.gateways.cashfree.utils import get_cashfree_order_id_from_payment
...
class Payment(CountableDjangoObjectType):
    ...
    cashfree_order_id = graphene.String(description = "Cashfree Order ID generated by Creating Payment on Cashfree")
    ...
    @staticmethod
    def resolve_cashfree_order_id(root: models.Payment, _info):
        return get_cashfree_order_id_from_payment(root)
