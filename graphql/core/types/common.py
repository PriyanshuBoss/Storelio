...
class BaseBankAccountInput(graphene.InputObjectType):
    
    active = graphene.Boolean(description="Active status of bank account", required=False)
    ac_name = graphene.String(description="Account Holder Name", required=True)
    ac_number = graphene.String(description="Bank Account Number", required=True)
    ac_bank_name = graphene.String(description="Bank Name", required=True)
    ac_bank_branch = graphene.String(description="Bank Branch", required=True)
    ac_ifsc_code = graphene.String(description="IFSC Code", required=True)


class BaseUpiIdInput(graphene.InputObjectType):
    
    active = graphene.Boolean(description="Active status of UPI ID", required=False)

    upi_id = graphene.String(description="UPI ID ", required=True)
