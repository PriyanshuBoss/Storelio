...
from saleor.store.store_utilities import is_user_have_store_access
...
class StoreBaseMutation(StoreMutationsMixin, BaseMutation):

    class Meta:
        abstract = True


class StoreModelMutation(StoreMutationsMixin, ModelMutation):

    class Meta:
        abstract = True


class StoreModelDeleteMutation(StoreMutationsMixin, ModelDeleteMutation):

    class Meta:
        abstract = True


class StoreBaseBulkMutation(StoreMutationsMixin, BaseBulkMutation):

    class Meta:
        abstract = True


class StoreModelBulkDeleteMutation(StoreMutationsMixin, ModelBulkDeleteMutation):
