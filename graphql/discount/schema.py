...
from .filters import SaleFilter, VoucherFilter, VoucherStoreDealFilter
from .mutations import (
    ...
    VoucherUpdate,
    AttachDealCardToStore
)
from .resolvers import resolve_sales, resolve_vouchers, resolve_voucher_store_deals
from .sorters import SaleSortingInput, VoucherSortingInput, VoucherStoreDealSortingInput
...
class VoucherStoreDealFilterInput(FilterInputObjectType):
    class Meta:
        filterset_class = VoucherStoreDealFilter
...
class DiscountQueries(graphene.ObjectType):
    ...
    voucher_store_deals = FilterInputConnectionField(
        VoucherStoreDeal,
        filter=VoucherStoreDealFilterInput(description="Filtering options for VoucherStoreDeals."),
        sort_by=VoucherStoreDealSortingInput(description="Sort voucher."),
        description="List of the shop's voucher deals.",
    )
    ...
    def resolve_voucher_store_deals(self, info, query=None, **kwargs):
        return resolve_voucher_store_deals(info, query, **kwargs)
...
class DiscountMutations(graphene.ObjectType):
    ...
    voucher_bulk_create = VoucherBulkCreate.Field()
    attach_deal_card_to_store = AttachDealCardToStore.Field()
