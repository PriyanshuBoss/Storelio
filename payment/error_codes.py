...
class PaymentErrorCode(Enum):
    ...
    NO_CHECKOUT_LINES = "no checkout lines are coming to create payment"
    PRODUCT_NOT_PUBLISHED = "product is not published by the brand to purchase"
    BRAND_INACTIVE = "brand got in-active"
