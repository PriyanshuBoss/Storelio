...
from .models import Category, Collection, ProductImage, ReelUpMediaImage
...
@app.task
def create_reel_up_thumbnails(image_id: str):
    """Take a ProductImage model and create thumbnails for it."""
    create_thumbnails(pk=image_id, model=ReelUpMediaImage, size_set="products")
